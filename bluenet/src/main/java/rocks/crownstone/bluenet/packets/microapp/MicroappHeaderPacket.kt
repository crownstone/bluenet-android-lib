...
class MicroappHeaderPacket(protocol: Uint8, appIndex: Uint8): PacketInterface {
	...
	override fun fromBuffer(bb: ByteBuffer): Boolean {
		...
		appIndex = bb.getUint8()
		return true
	}

	override fun toString(): String {
		return "MicroappHeaderPacket(protocol=$protocol, appIndex=$appIndex)"
	}
}
