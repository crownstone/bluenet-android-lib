...
object BluenetProtocol {
	...
	val CHAR_SETUP_SESSION_DATA_UNENCRYPTED_UUID =   UUID.fromString("24f1000f-7d10-4805-bfc1-7663a01c3bff")
...
enum class ControlTypeV4(val num: Uint16) {
	...
	GET_UICR_DATA(5U),
	SET_IBEACON_CONFIG_ID(6U),
	GET_MAC_ADDRESS(7U),
	GET_HARDWARE_VERSION(8U),
	GET_FIRMWARE_VERSION(9U),
	RESET(10U),
	GOTO_DFU(11U),
	NOOP(12U),
	DISCONNECT(13U),
	...
	REGISTER_TRACKED_DEVICE(70U),
	TRACKED_DEVICE_HEARTBEAT(71U),
	GET_PRESENCE(72U),
	GET_UPTIME(80U),
	...
	GET_RAM_STATS(88U),
	MICROAPP_GET_INFO(90U),
	MICROAPP_UPLOAD(91U),
	MICROAPP_VALIDATE(92U),
	MICROAPP_REMOVE(93U),
	MICROAPP_ENABLE(94U),
	MICROAPP_DISABLE(95U),
	MICROAPP_MESSAGE(96U),
	CLEAN_FLASH(100U),
	UNKNOWN(0xFFFFU);
	companion object {
...
enum class StateTypeV4(val num: Uint16) {
	...
	ERRORS(139U),
	SUN_TIME(149U),
	BEHAVIOUR_SETTINGS(150U),
	MESH_IV_INDEX(151U),
	MESH_SEQ_NUMBER(152U),
	BEHAVIOUR_MASTER_HASH(153U),
	IBEACON_CONFIG_ID(154U),
	MICROAPP(155U),
	SOFT_ON_SPEED(156U),
	HUB_MODE(157U),
	UART_KEY(158U),
...
enum class DeviceType(val num: Uint8) {
	...
	CROWNSTONE_HUB(7U),
	SOCKET_F(10U),
	PROTO_WITH_DIMMER(252U),
	PROTO_WITH_RELAY(253U),
	PROTO_WITHOUT_SWITCH(254U);
	companion object {
